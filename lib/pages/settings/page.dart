...
class SettingsPage extends StatelessWidget {
          ...
          builder: (context, _) {
            return ListView(
              children: [
                ...
                _buildDivider(),
                ..._buildGeneral(context, logic),
                ListTile(title: _buildGroupTitle('terminal'.tr(context))),
                _buildDivider(),
                ..._buildTerminal(context, logic),
              ],
            );
          },
        );
  ...
  List<Widget> _buildGeneral(BuildContext context, SettingsLogic logic) {
    return [
      ListTile(
        ...
        trailing: MenuAnchor(
          ...
          menuChildren: [
            MenuItemButton(
              onPressed: () =>
                  logic.onUpdateSettings({'themeMode': ThemeMode.system}),
              child: Text('systemTheme'.tr(context)),
            ),
            MenuItemButton(
              onPressed: () =>
                  logic.onUpdateSettings({'themeMode': ThemeMode.light}),
              child: Text('lightTheme'.tr(context)),
            ),
            MenuItemButton(
              onPressed: () =>
                  logic.onUpdateSettings({'themeMode': ThemeMode.dark}),
      ...
      ListTile(
        ...
        trailing: Switch(
          ...
          onChanged: defaultTargetPlatform.supportsAccentColor
              ? (value) => logic.onUpdateSettings({'dynamicColor': value})
              : null,
  ...
  List<Widget> _buildTerminal(BuildContext context, SettingsLogic logic) {
    return [
      ListTile(
        ...
        trailing: SizedBox(
          ...
          child: TextField(
            ...
            onEditingComplete: () => logic
                .onUpdateSettings({'timeout': logic.timeoutController.text}),
          ),
        ),
      ),
      ListTile(
        ...
        trailing: SizedBox(
          ...
          child: TextField(
            ...
            textAlign: TextAlign.center,
            onEditingComplete: () => logic
                .onUpdateSettings({'maxLines': logic.maxLinesController.text}),
          ),
        ),
      ),
    ];
